...
class BinanceClient:
    ...
    def get_contracts(self) -> typing.Dict[str, Contract]:
        ...
        """
        Get a list of symbols/contracts on the exchange to be displayed in the OptionMenus of the interface_old.
        :return:
        """
    ...
    def _start_ws(self):
        ...
        while True:
            try:
                if self.reconnect:  # Reconnect unless the interface_old is closed by the user
