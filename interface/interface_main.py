...
class interface(tk.Tk):
    def __init__(self, bitmex: BitmexClient, binance: BinanceClient):
            ...
            self.watch_list = WatchList(self.left_frame, binance_contracts=binance.contracts,
                                        bitmex_contracts=bitmex.contracts,  bg_color=self.bg_color,
            ...
            self.trade_frame = TradingFrame(self.right_frame, bg=self.bg_color)
    ...
    def  update_color(self):
        ...
        self.left_frame.config(bg=self.bg_color)
        ...
        self.watch_list.update_color(new_bg_color=self.bg_color, new_fg_color=self.fg_color)
