...
import typing
import tkinter as tkmac

import json

from interface_old.styling import *
from interface_old.scrollable_frame import ScrollableFrame
...
if typing.TYPE_CHECKING:
    from interface_old.root_component import Root
...
class StrategyEditor(tk.Frame):
    ...
    def _switch_strategy(self, b_index: int):
        ...
        Collects initial historical data (hence why there is a small delay on the interface_old after you click).
        :param b_index:
        :return:
        """
